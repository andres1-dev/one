...
async function llamarAPI(params) {
    try {
        ...
        // Para Google Apps Script necesitamos seguir redirecciones manualmente
        if (response.redirected) {
            ...
            try {
                ...
                return { success: true }; // Asumimos éxito si no podemos parsear
            }
        } else {
...
// Función para cambiar responsable (ACTUALIZADA CON API)
...
// Función para cambiar estado del documento (ACTUALIZADA CON API)
...
// Función para restablecer documento (ACTUALIZADA CON API)
