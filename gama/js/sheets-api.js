...
class SheetsAPI {
    ...
    // Obtener TODOS los datos unificados (DATA2 + REC) - HOMOLOGADO DEL GAS
    async obtenerDatosCompletos() {
        try {
            ...
            // Combinar TODOS los datos (homologado del GAS)
    ...
    // Combinar TODOS los datos de ambas fuentes (HOMOLOGADO DEL GAS)
    combinarTodosLosDatos(datosData2, datosSiesa, datosData, datosSoportes, datosRec, datosGlobales) {
        const datosCombinados = [];
        
        console.log('🔄 Combinando datos de DATA2 y REC...');
        
        // Procesar datos de DATA2 (HOMOLOGADO DEL GAS)
        ...
        // Procesar datos de REC (HOMOLOGADO DEL GAS)
    ...
    // FUNCIONES AUXILIARES HOMOLOGADAS DEL GAS
